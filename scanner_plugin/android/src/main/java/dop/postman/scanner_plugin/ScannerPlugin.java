...
/** ScannerPlugin */
public class ScannerPlugin implements MethodCallHandler, ActivityResultListener, StreamHandler, FlutterPlugin, ActivityAware {
  private static final String CHANNEL = "scanner_plugin";
  ...
  private ScannerPlugin(FlutterActivity activity, final PluginRegistry.Registrar registrar) {
    ScannerPlugin.activity = activity;
  }
  ...
  public static void registerWith(final PluginRegistry.Registrar registrar) {
    ...
    ScannerPlugin instance = new ScannerPlugin((FlutterActivity) registrar.activity(), registrar);
...
//        pendingResult.success("-1");
  ...
  private void createPluginSetup(
    ...
    eventChannel =
            new EventChannel(messenger, "scanner_plugin_receiver");
