package dop.postman.scanner_plugin.camera;
...
import dop.postman.scanner_plugin.BarcodeCaptureActivity;
import dop.postman.scanner_plugin.ScannerPlugin;
import dop.postman.scanner_plugin.constants.AppConstants;
import dop.postman.scanner_plugin.utils.AppUtil;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public GraphicOverlay(Context context, AttributeSet attrs) {
        ...
        lineColor = Color.parseColor(ScannerPlugin.lineColor);
