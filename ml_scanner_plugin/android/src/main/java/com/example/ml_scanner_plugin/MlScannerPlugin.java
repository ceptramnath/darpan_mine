...
/** MlScannerPlugin */
public class MlScannerPlugin implements MethodCallHandler,QrReaderCallbacks,QrReader.QRReaderStartedCallback,PluginRegistry.RequestPermissionsResultListener,FlutterPlugin,ActivityAware {


  private static final String TAG="MLVisPlugin";
  ...
  public static void registerWith(Registrar registrar){
    MlScannerPlugin plugin=new MlScannerPlugin();
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding binding){
    performV2Regisration(flutterPluginBinding,binding);
  }
  ...
  private void performV2Regisration(FlutterPluginBinding flutterPluginBinding,ActivityPluginBinding activityPluginBinding){
  ...
  private void performRegistration(boolean isVersion1Embedding,Registrar registrar,FlutterPluginBinding flutterPluginBinding,ActivityPluginBinding activityPluginBinding){
    ...
    channel=new MethodChannel(messenger,"ml_scanner_plugin");
  ...
  public boolean onRequestPermissionsResult(int requestCode,String[] permissions,int[] grantResults){
    if(requestCode==REQUEST_PERMISSION){
      ...
      if(grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
        Log.i(TAG,"Permission request granted.");
        stopReader();
      }
      else{
    ...
    switch(methodCall.method){
      case "start":{
        if(permissionDenied){
          ...
          lastHeartbeatTimeout=methodCall.argument("headerBeatTimeout");
          ...
          if(targetWidth==null || targetHeight==null){
            result.error("INVALID_ARGUMENT","Missing a required argument","Expecting targetWidth,targetHeight, and optionally heartbeat Timeout");
            break;
          }
          ...
          QrReader reader=new QrReader(targetWidth,targetHeight,activity,options,this,this,textureEntry.surfaceTexture());
          readingInstance=new ReadingInstance(reader,textureEntry,result);
          try{
            reader.start(lastHeartbeatTimeout==null ?0:lastHeartbeatTimeout);
          }catch(IOException e){
            e.printStackTrace();
