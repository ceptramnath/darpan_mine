...
class ParcelBookingScreen extends StatefulWidget {
  const ParcelBookingScreen({Key? key}) : super(key: key);

  @override
  _ParcelBookingScreenState createState() => _ParcelBookingScreenState();
}
...
class _ParcelBookingScreenState extends State<ParcelBookingScreen> {
                  ...
                  child: Center(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        final ifPresent = await ParcelBooking()
                            .select()
                            .ArticleNumber
  ...
  getTotalAmount() {
    ...
    print(
        "Weight amount $weightAmt, Insurance amount $insAmt, VPP amount $vppAmt, Acknowledge amount $ackAmt, Prepaid amount $ppAmt, Registration fee $registrationFee, Air mail amount $airMailAmt, Door delivery fee $doorDeliveryFee");
  ...
  printFunction() async {
    ...
    //     valuePayableCheck == true ? valuePayablePostController.text : '0',
    //     airMailServiceCheck == true ? airMailAmt.toString() : '0', '0', '0',
    ...
    //     addresseeMobileNumberController.text, 'Parcel');
    ...
    BookingDBService().addParcelToDB(
    ...
    final addCash =  CashTable()
      ...
      ..Cash_Description = 'Parcel Booking';
    await addCash.save();
