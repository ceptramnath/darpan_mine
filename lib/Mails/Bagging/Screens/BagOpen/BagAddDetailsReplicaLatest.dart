...
class _BagAddDetailsReplicaState extends State<BagAddDetailsReplica> {
      ...
      if (bagAddedStamps.isNotEmpty) {
        ...
        for (int i = 0; i < bagAddedStamps.length; i++) {
          ...
          expansionInventoryTotal.add(
              double.parse(bagAddedStamps[i]['StampQuantity']) *
                  double.parse(bagAddedStamps[i]['StampPrice']));
            ...
            if (product.isNotEmpty) {
              for (int j = 0; j < product.length; j++) {
                if (!expansionInventoryName
                  ...
                  //MENGE COLUMN is quantity only. So no need to divide by sale price
                  var salePrice =
                      (double.parse(product[j]['SalePrice']));//.toInt();
                  var total = (double.parse(bagStamps[i]['MENGE_D'])).toInt() * double.parse(product[j]['SalePrice']);
                  ...
                  receivedInventory =false;
                  print("receivedInventory value is :${receivedInventory} ");
  ...
  //       }
  //     } else {
  //       Toast.showFloatingToast('$scan is not received', context);
  //     }
  //   });
  // }
  ...
  void _dropDownItemSelected(String valueSelectedByUser) {
    setState(() {
      ...
      if (valueSelectedByUser == 'VPP' ||
          ...
          valueSelectedByUser == 'SP-COD'||
          valueSelectedByUser == 'BP-COD'
      ) {
            ...
            builder: (BuildContext context, StateSetter setState) {
              return Column(
                ...
                children: [
                  ...
                  typeOfArticle == 'VPL' ||
                          typeOfArticle == 'COD' ||
                      typeOfArticle == 'SP-COD' ||
                      typeOfArticle == 'BP-COD' ||
                      typeOfArticle == 'VPP'
                      ? Container(
                          decoration: BoxDecoration(
                              color: Colors.grey.withOpacity(.1),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      controller: editInventoryQuantityController
                        ..text = quantity,
                      onChanged: (text) {
                        editInventoryTotalController.text = (double.parse(text) *
                            double.parse(editInventoryPriceController.text))
                        //editInventoryTotalController.text = (int.parse(text) *
                            //    int.parse(editInventoryPriceController.text))
                        // Issue observed for ILC.. amount in double
                            .toString();
                      },
                      style: const TextStyle(
                          color: ColorConstants.kTextColor, letterSpacing: 1),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (text) {
                        editInventoryTotalController.text = (double.parse(text) *
                            double.parse(editInventoryQuantityController.text))
                            .toString();
                        // editInventoryTotalController.text = (int.parse(text) *
                            ...
                            Expanded(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    //selectedArticle is true means data entry
                                    else if(selectedArticle== true && selectedRegularArticle== true && artval.validate(articleNumberController.text) != "Valid")
                                    {
                                      Toast.showFloatingToast(
                                    ...
                                    else if(selectedArticle== true && selectedEMOArticle == true && emoval.validate(articleNumberController.text) != "Valid")
                                    {
                                      Toast.showFloatingToast(
                                      ...
                                      // }
                                        ...
                                        if (!selectedArticle &&
                                          ...
                                          Toast.showFloatingToast(
                                            ...
                                            emoAmountController.text.isNotEmpty && int.parse(emoAmountController.text) > 5000 ) {
                                          print('inside eMO amount condition');
                                          Toast.showFloatingToast(
                                              'Enter a valid EMO Amount', context);
                                        } else if ((typeArticle == "SP-COD" || typeArticle == "BP-COD") &&
                                            vpAmountController.text.isNotEmpty && int.parse(vpAmountController.text) > 50000 ) {
                                          Toast.showFloatingToast('Enter a valid COD Amount', context);
                                          vpAmountController.text="";
                                        }
                                        else if ((typeArticle == "VPP" || typeArticle == "VPL") &&
                                            vpAmountController.text.isNotEmpty && int.parse(vpAmountController.text) > 5000 ) {
                                          Toast.showFloatingToast('Enter a valid VP Amount', context);
                                          vpAmountController.text="";
                                        }
                                        else if (selectedEMOArticle == true &&
                              ...
                              Row(
                                children: [
                                  Expanded(
                                      flex:
                                      // typeArticle != "COD" ?2:4,
                                       typeArticle == "SP-COD" ? 4 : typeArticle == "BP-COD"? 4:2,
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            typeArticle == "SP-COD"
                                                ? 'COD Amount':
                                            typeArticle == "BP-COD"?'COD Amount':'VP Amount',
                                  ...
                                  Visibility(
                                    visible:
                                        ...
                                        typeArticle =="SP-COD"?false:
                                        typeArticle =="BP-COD"?false:true,
                                    child: Expanded(
                                        flex: 2,
                                        child: TextFormField(
                                          readOnly: true,
                                                            ...
                                                            Expanded(
                                                                ...
                                                                child:
                                                                    IconButton(
                                                                        onPressed:
                                                                            () {
                                                                          print('inside delete button press');
                                                                          showInventoryDeleteDialog(
                                                                              expansionInventoryName[index].toString(),
                                                                              expansionInventoryQuantity[index].toString(),
                                                                              expansionInventoryPrice[index].toString(),
                                                                              expansionInventoryTotal[index].toString());
                                                                          print("receivedInventory value in delete dialog : ${receivedInventory}");
                                                                        },
                                                                        icon:
                                                                            Icon(
                                                                          Icons
                                                                    ...
                                                                    IconButton(
                                                                        onPressed:
                                                                          ...
                                                                          showInventoryEditDialog(
                                                                              ...
                                                                              expansionInventoryPrice[index].toString(),
                                                                              expansionInventoryTotal[index].toString());
                                                                          print("receivedInventory value in EDIT dialog : ${receivedInventory}");
                                                                        },
                                                                        icon:
                                                                            const Icon(
                                                                          Icons
  ...
  addArticlesToBag() async {
    ...
    if (expansionArticle.isNotEmpty) {
      ...
      for (int i = 0; i < expansionArticle.length; i++) {
        ...
        print(jsonBagArticles);
        print("--");
        print(expansionArticle[i]);
        print("===============");
        print(!jsonBagArticles.contains(expansionArticle[i]));
        ...
        if (!jsonBagArticles.contains(expansionArticle[i])) {
          ...
          //     .toString();
          print("Going to update Delivery Table..!");
    ...
    if (expansionInventoryName.isNotEmpty) {
      for (int i = 0; i < expansionInventoryName.toSet().toList().length; i++) {
        await BaggingDBService().addInventoryFromBagToDB(
            ...
            (double.parse(expansionInventoryPrice[i].toString()) *
                    double.parse(expansionInventoryQuantity[i].toString()))
                .toString(),
            widget.bagNumber,
            'Added');
  ...
  saveInventoryToBag() async {
    if (expansionInventoryName.isNotEmpty) {
      ...
      //Added on 03-03-2023 to Update the flag as Y for the inventory received
      await BOSLIP_STAMP1()
          .select()
          .BO_SLIP_NO
          .equals(boSlipNumber)
