...
//                                   } else if (selectedEMOArticle == true &&
//                                       vpCommissionController.text.isEmpty) {
//                                     Toast.showFloatingToast(
...
//                                       receivedArticles.add(false);
//                                       expansionArticle
//                                           .add(articleNumberController.text);
//                                       expansionArticleType.add(typeArticle);
//                                       articleNumberController.clear();
...
//                                     vertical: 5.h.toDouble()),
//                                 margin:
//                                     EdgeInsets.only(right: 8.0.w.toDouble()),
//                                 decoration: const BoxDecoration(
//                                   color: ColorConstants.kSecondaryColor,
//                                 ),
//                                 child: IconButton(
...
//           String com = expansionCommission.length==0?"0":expansionCommission[i].toString();
//           String amount = expansionAmount.length==0?"0":expansionAmount[i].toString();
//           await BaggingDBService().addArticlesToDelivery(
//               widget.bagNumber,
//               expansionArticle[i],
//               expansionArticleType[i],
//               com,amount);
//         }
...
//       BaggingDBService().addBAGDETAILS_NEW(widget.bagNumber,(expansionArticle.length+1).toString());
//
//     }
//   }
//
...
//           await BaggingDBService().updateBagArticlesToDB(widget.bagNumber,
//               expansionArticle[i], expansionArticleType[i], 'Added');
//           await BaggingDBService().addArticlesToDelivery(widget.bagNumber,
//               expansionArticle[i], expansionArticleType[i], commission, amount);
//         }
//       }
//     }
//   }
