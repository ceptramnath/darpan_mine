...
// //                                             var request = http.Request('POST', Uri.parse(APIEndPoints().cbsURL1));
...
// //                                                                             List
// //                                                                                 t =
// //                                                                                 resheaders['authorization']!.split(", Signature:");
// //                                                                             String
// //                                                                                 res =
// //                                                                                 await response.stream.bytesToString();
// //                                                                             String
...
// //
// //                                                                                   var request = http.Request('POST', Uri.parse(APIEndPoints().cbsURL));
// //                                                                                   request.files.add(await http.MultipartFile.fromPath('file', '$cachepath/RDfetchAccountDetails.txt'));
// //                                                                                   request.headers.addAll(headers);
// //
// //                                                                                   // var request =
...
// //       //     "${goResponse.replaceAll("{", "").replaceAll("}", "").split("\n")[3]}"
// //       //     "";
// //       text ='{"2":"${myController.text}","3":"820000","11":"${GenerateRandomString().randomString()}","12":"${DateTimeDetails().cbsdatetime()}","17":"${DateTimeDetails().cbsdate()}","24":"200","32":"607245","49":"INR","102":"111        ${login[0].SOL_ID}${myController.text}","123":"SDP"}\n\n';
// //       print(" fetch account details text");
// //       print(text.split("\n\n")[0].trim().toString());
// //
// //      LogCat().writeContent(" Cash Deposit ${text.split("\n\n")[1]}");
// //       await file.writeAsString(text.split("\n\n")[0].trim().toString(), mode: FileMode.append);
// //       // String test = await Newenc.signString(text.trim().toString());
// //       String test = await Newenc.signString(text.split("\n\n")[0].trim().toString());
// //       print("Signture is: " + test);
// //       String verificationResult=await Newenc.verifyString(test, text.split("\n\n")[0].trim().toString());
// //       print("Verification Result is $verificationResult");
// //       return test;
// //     }
// //   }
// //
...
// //       return "false";
// //     } else {
// //       final file = await File('$cachepath/fetchRDAccountDetails.txt');
// //       file.writeAsStringSync('');
// //       String? goResponse = await Newenc.tester(
// //           "$cachepath/fetchRDAccountDetails.txt",
// //           "requestJson",
...
// //       String mainrebpadding = rebpadding.padRight(23, '0');
// //       print("Main Def Padding: $maindefpadding");
// //       final file = await File('$cachepath/RDfetchAccountDetails.txt');
// //       file.writeAsStringSync('');
// //       // String text='{"2":"${myController.text}","3":"490000","4":"$padt","11":${GenerateRandomString().randomString()},"12":"${DateTimeDetails().cbsdatetime()}","17":"${DateTimeDetails().cbsdate()}","24":"200","32":"607245","49":"INR","103":"  111        50007504${myController.text}","123":"SDP","126":"BO11202102003_50343458_BY CASH  "}';
// //       String? goResponse = await Newenc.tester(
// //           "$cachepath/RDfetchAccountDetails.txt", "requestJson", "jsonInStream");
// //       String bound =
// //           goResponse.replaceAll("{", "").replaceAll("}", "").split("\n")[0];
// //
// //       String text = "$bound"
