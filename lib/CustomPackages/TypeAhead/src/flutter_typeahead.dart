/// # Flutter Package.TypeAhead
/// A Package.TypeAhead widget for Flutter, where you can show suggestions to
/// users as they type
///
/// ## Features
...
/// callback here. The Package.TypeAhead widget takes care of that.
///
...
///
/// ## Customizations
/// Package.TypeAhead widgets consist of a TextField and a suggestion box that shows
...
/// Package.TypeAhead provides default configurations for the suggestions box. You can,
...
class TypeAheadFormField<T> extends FormField<String> {
  ...
  /// that the Package.TypeAhead widget displays
...
class TypeAheadField<T> extends StatefulWidget {
  ...
  ///
  /// This callback must not be null. It is be called by the Package.TypeAhead widget
  ...
  ///
  /// This callback must not be null. It is called by the Package.TypeAhead widget and
  ...
  ///
  /// This callback must not be null. It is called by the Package.TypeAhead widget for
...
/// Supply an instance of this class to the [Package.TypeAhead.suggestionsBoxDecoration]
...
/// Supply an instance of this class to the [Package.TypeAhead.textFieldConfiguration]
...
class TextFieldConfiguration {
  ...
  /// A typical use case for this field in the Package.TypeAhead widget is to set the
...
/// Supply an instance of this class to the [Package.TypeAhead.suggestionsBoxController]
