...
class SaveScannedArticleScreen extends StatefulWidget {
  String? articles;
  String? articleTypes;
  String? deliverStat;
  String? addresseeTy;
  ...
  SaveScannedArticleScreen(this.pageredirection, this.articles,
  ...
  @override
  _SaveScannedArticleScreenState createState() =>
      _SaveScannedArticleScreenState();
}

class _SaveScannedArticleScreenState extends State<SaveScannedArticleScreen> {
  ...
  // List depositValues=['1 Day  Demurrage: \u{20B9} 0.00','2 Days  Demurrage: \u{20B9} 0.00','3 Days  Demurrage: \u{20B9} 0.00','4 Days  Demurrage: \u{20B9} 0.00','5 Days  Demurrage: \u{20B9} 0.00','6 Days  Demurrage: \u{20B9} 0.00','7 Days  Demurrage: \u{20B9} 0.00'];
  // List VPLdepositValues=['1 Day  Demurrage: \u{20B9} 0.00','2 Days  Demurrage: \u{20B9} 0.00','3 Days  Demurrage: \u{20B9} 0.00','4 Days  Demurrage: \u{20B9} 0.00','5 Days  Demurrage: \u{20B9} 0.00','6 Days  Demurrage: \u{20B9} 0.00','7 Days  Demurrage: \u{20B9} 0.00','8 Days  Demurrage: \u{20B9} 2.00','9 Days  Demurrage: \u{20B9} 4.00','10 Days  Demurrage: \u{20B9} 6.00','11 Days  Demurrage: \u{20B9} 8.00','12 Days  Demurrage: \u{20B9} 10.00','13 Days  Demurrage: \u{20B9} 12.00','14 Days  Demurrage: \u{20B9} 14.00'];
  // List VPPdepositValues=['1 Day  Demurrage: \u{20B9} 0.00','2 Days  Demurrage: \u{20B9} 0.00','3 Days  Demurrage: \u{20B9} 0.00','4 Days  Demurrage: \u{20B9} 0.00','5 Days  Demurrage: \u{20B9} 0.00','6 Days  Demurrage: \u{20B9} 0.00','7 Days  Demurrage: \u{20B9} 0.00','8 Days  Demurrage: \u{20B9} 3.00','9 Days  Demurrage: \u{20B9} 6.00','10 Days  Demurrage: \u{20B9} 9.00','11 Days  Demurrage: \u{20B9} 12.00','12 Days  Demurrage: \u{20B9} 15.00','13 Days  Demurrage: \u{20B9} 18.00','14 Days  Demurrage: \u{20B9} 21.00'];
  String? emoValue;
  bool redirectVisible = false;
  int? actionCode;
  @override
  void initState() {
    print('initstate in delivery remark screen');
    _getUserLocation();
    if (widget.vpp == "X") {
      print("VPP Condition..!");
            ...
            if (snapshot.data == null) {
              ...
              return Column(
                children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    // if(widget.vpp=="X" && widget.articleTypes=="Registered Letter")
                                    // Expanded(
                                    //   child: Padding(
                                    ...
                                    //
                                    //               });
                                    //               dem=depositText!.split('\u{20B9}');
                                    //               print(dem[1]);
                                    //
                                    //             },
                                    //             items: VPLdepositValues.map((value) {
                                    //               return DropdownMenuItem(
                                    //                   value: value,
                                    //                   child: Text(
                                    //                     value,
                  ...
                  Visibility(
                    visible: redirectPincodeController.text.isEmpty
                        ? false
                        : true,
                    child: CInputForm(
                      readOnly: true,
                      ...
                      labelText: 'City',
                      controller: redirectCityController,
                      textType: TextInputType.text,
                      typeValue: 'City',
                      focusNode: redirectCityFocus,
                    ),
                  ),
                  Visibility(
                    visible: redirectPincodeController.text.isEmpty
                    ...
                    child: CInputForm(
                      ...
                      iconData: Icons.location_city,
                      labelText: 'State',
                      controller: redirectStateController,
                      textType: TextInputType.text,
                      typeValue: 'City',
                      focusNode: redirectStateFocus,
                    ),
                  ),
                ],
              );
                              ...
                              onPressed: () async {
                                ...
                                if (deliverStatus != "DELIVERY")
                                  finalresult = await Reason()
                                      ...
                                      .endBlock
                                      .toList();
                                // print(finalresult[0].resonfornonDelivery);
                                try {
                                  if (mounted) {
                                    print("Entered saving");
                                    ...
                                    final scannedArticle = await Delivery()
                                      ...
                                      'DATE_OF_1ST_DELIVERY_CONFIRM':
                                          DateTimeDetails().onlyDate(),
                                      //Article Receive Data & Time updates while bag open.
                                    ...
                                    // if(deliverStatus!="DELIVERY" && reason=="ON ADDRESSEE INSTRUCTIONS"){
                                    //   print("Entered as Non Delivery");
                                    //   var i=dem[1].split(".");
                                    //   print(i);
                                    ...
                                    //     ..Cash_Description = "VPL Demurrage";
                                    //   addCash1.save();
                                    //
                                    //   print("Saving done");
                                    // }

                                    if (widget.vpp == "X" && deliverStatus == "DELIVERY") {
                                  ...
                                  print("Exception in Delivery Information Storing:" + e.toString());
                                }
                              },
                              icon: Icon(
  ...
  getreasons() async {
    ...
    print("Reason Types: ${reasonTypes[0]}");
    print("Action Code: ${reasons[0].ACTION}");
    ...
    action = actionText[0].ACTION_TEXT;
    print("Reasons length: ${reasonTypes.length}");
