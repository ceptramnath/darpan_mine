...
class ArticleDisplayCard extends StatelessWidget {
  ...
  ArticleDisplayCard(this.articleNumber, this.articleType, this.sourcepin,
      this.destpin, this.cod, this.vpp, this.amounttocollect);
