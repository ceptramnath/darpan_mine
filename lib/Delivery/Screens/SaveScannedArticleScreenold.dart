...
//   int? pageredirection;
//
//   SaveScannedArticleScreen(
//       this.pageredirection, this.articles, this.articleTypes, this.addressee,this.cod,this.vpp,this.amount,
//       [this.deliverStat,
//         this.addresseeTy,
...
//                                           ..Cash_Type = 'Add'
//                                           ..Cash_Amount = widget.amount
//                                           ..Cash_Description = widget.vpp=='Y'?"VPL":"COD";
//                                         await addCash.save();
//                                       }
...
//
//   ConformationText() {
//     if ( deliverStatus == 'Delivered'   && (widget.cod=="Y" || widget.vpp=="Y")) {
//       return Text(
//         '${widget.articles} will be marked as Delivered/Payment of ${"\u{20B9} ${widget.amount}"} collected from ${deliveredToNameController.text.isEmpty ? widget.deliveredToName : deliveredToNameController.text}. \n \nDo you want to take Final Returns?',
//         style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54),
//       );
//     } else if (deliverStatus == "Delivered") {
//       return Text(
//         'All the articles addressed to ${widget.addressee} will be marked as Delivered to ${deliveredToNameController.text.isEmpty ? widget.deliveredToName : deliveredToNameController.text}. \n\nDo you want to take Final Returns?',
//         style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54),
//       );
//     } else if (
