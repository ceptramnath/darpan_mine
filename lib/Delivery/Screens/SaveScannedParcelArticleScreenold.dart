...
// }
//
// class _SaveScannedParcelArticleScreenState extends State<SaveScannedParcelArticleScreen> {
...
//       return Text(
//         '${widget.articles} will be marked as Delivered/Amount of ${"\u{20B9} ${widget.amount}"} collected from ${deliveredToNameController.text.isEmpty ? widget.deliveredToName : deliveredToNameController.text}. \n \nDo you want to take Final Returns?',
//         style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54),
//       );
//     }
//     if ( deliverStatus == 'Delivered' && (widget.cod=="Y" || widget.vpp=="Y")) {
//       return Text(
//         '${widget.articles} will be marked as Delivered to ${deliveredToNameController.text.isEmpty ? widget.deliveredToName : deliveredToNameController.text}. \n \nDo you want to take Final Returns?',
//         style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54),
//       );
//     } else if (deliverStatus == "Delivered") {
//       return Text(
//         'All the articles addressed to ${widget.addressee} will be marked as Delivered/Payment done to ${deliveredToNameController.text.isEmpty ? widget.deliveredToName : deliveredToNameController.text}. \n\nDo you want to take Final Returns?',
//         style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black54),
//       );
//     } else if (
