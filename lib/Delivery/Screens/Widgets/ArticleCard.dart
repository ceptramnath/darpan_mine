...
class ArticleCard extends StatelessWidget {
  ...
  ArticleCard(
      this.articleNumber, this.articleType, this.sourcepin, this.destpin);
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                //               child: Text(
                //                 remark,
                //                 style: TextStyle(color: remarkColor, fontWeight: FontWeight.w500, fontSize: 18.sp),
                //               ),
                //             ),
                //             RichText(
                //               text: TextSpan(
                ...
                //                 children: <TextSpan>[
                //                   TextSpan(text: time!, style: TextStyle(color: Colors.black54)),
                //                 ],
                //               ),
                //             )
                //           ],
